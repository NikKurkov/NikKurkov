<h1 align="center">Привет! Меня зовут Ник&nbsp;👋</h1>

<p align="center">
  Я&nbsp;Python‑разработчик, увлечённый Django, FastAPI и&nbsp;всем, что связано с&nbsp;бэкендом, автоматизацией и&nbsp;современными технологиями.<br>
  Постепенно прокачиваю свои навыки и&nbsp;создаю проекты&nbsp;— от e‑commerce до API‑сервисов.
</p>
...
- 🔭 Сейчас работаю над собственным e‑commerce‑проектом и пишу плагины для Webasyst  
- 🌱 Изучаю Django REST Framework, FastAPI, Pytest/Unittest, Docker Compose  
- 👀 Интересуюсь кибербезопасностью, блокчейном и инфраструктурой  
- 🎯 Цель — стать сильным backend‑разработчиком и внести вклад в IT‑сообщество  
...
- **Telegram:** [@nikkurkov](https://t.me/nikkur)  
- **Email:** nikkurkov@gmail.com  
